...
function AboutPage() {
  return (
    <div>
      ...
      <Reveal
        delay={0.3}
        className="mx-auto max-w-6xl px-4 py-16 grid md:grid-cols-2 gap-10 items-center"
      >
        <img
      ...
      <section className="border-y bg-secondary/50">
        <RevealGroup className="mx-auto max-w-6xl px-4 py-12 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
        ...
        <RevealGroup className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {values.map(({ icon: Icon, title, desc }) => (
            <Card className="hover:bg-accent">
              <CardContent>
                <RevealItem key={title} className="text-center space-y-3">
      ...
      {/* CTA */}
      <Reveal className="mx-auto max-w-6xl px-4 py-16 text-center space-y-4">
